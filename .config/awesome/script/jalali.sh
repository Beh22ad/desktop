...
# and print it in the format: [Persian Day-of-Week] [year]/[month]/[day] (all in Persian digits)
# Based on the algorithm from the Kotlin code
...
# Output the final string in the format: [DayOfWeek] [year]/[month]/[day]
echo "$persianDay $pjy/$pjm/$pjd"
